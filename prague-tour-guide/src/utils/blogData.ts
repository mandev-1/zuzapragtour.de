...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    titleKey: 'blog.post33.title',
    excerptKey: 'blog.post33.excerpt',
    dateKey: 'blog.post33.date',
    date: '2026-04-26',
    image: '/images/old-town-square.jpg',
    ogImage: '/images/best-tourguide-prag-thumbnail-early-2026.png',
    contentKey: 'blog.post33.content',
    author: 'Ing. Zuzana Manová',
    tags: [],
    tagsDe: [
      'was kann man in Prag machen', 'Prag Sehenswürdigkeiten', 'beste Orte Prag',
      'Prag Aktivitäten', 'Prag Tipps', 'Prag Highlights', 'was tun in Prag',
      'Prag Urlaub', 'Prag besuchen', 'Prag Ausflug', 'Prag Stadtführung',
      'Prag Geheimtipps', 'Sehenswürdigkeiten Prag Altstadt',
    ],
    language: 'de',
  },
  {
    id: '32',
    slug: 'best-photo-spots-prague',
    slugDe: 'beste-fotospots-prag',
    titleKey: 'blog.post32.title',
    excerptKey: 'blog.post32.excerpt',
    dateKey: 'blog.post32.date',
    date: '2026-04-26',
    image: '/images/guest-photo-food.jpeg',
    ogImage: '/images/best-tourguide-prag-thumbnail-early-2026.png',
    contentKey: 'blog.post32.content',
    author: 'Ing. Zuzana Manová',
    tags: [
      'best photo spots Prague', 'Prague photography', 'Prague Instagram spots',
      'where to take pictures Prague', 'Prague views', 'Prague sunrise photography',
      'Charles Bridge photo', 'Prague Castle view', 'Prague hidden photo spots',
      'Old Town Square Prague photo', 'Letna Park Prague view', 'Vysehrad Prague',
    ],
    tagsDe: [
      'beste Fotospots Prag', 'Prag Fotografie', 'Prag Instagram',
      'Prag Fotolocations', 'Prag Aussichtspunkte', 'Prag Sonnenaufgang Foto',
      'Karlsbrücke Foto', 'Prager Burg Aussicht', 'Prag geheime Fotospots',
      'Altstädter Ring Prag Foto', 'Letná Park Prag', 'Vyšehrad Prag',
    ],
    language: 'both',
  },
  {
    ...
    date: '2026-04-25',
    image: '/images/photo-guests-mala-strana-from-castle.jpeg',
    ogImage: '/images/best-tourguide-prag-thumbnail-early-2026.png',
