// Blog-specific translations extracted from translations.ts

export const blogTranslations = {
  // Blog Page UI
  'blog.title': {
    en: 'Prague Travel Blog',
    de: 'Prag Reiseblog',
  },
...
<div class="blog-cta-box">
  ...
  <p>Sagen Sie mir Ihren Stil—Rooftop‑Blicke, Speakeasy‑Tasting oder Craft‑Beer‑Runde—und ich plane eine sichere, begehbare Route mit Reservierungen und letztem Tram‑Timing.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Individuelle%20Privattour#contact-title">Private Night‑Tour buchen</a>
    <a class="btn btn-outline" href="/contact#contact-title">Empfehlungen anfragen</a>
  </div>
  </div>
...
<div class="blog-cta-box">
  ...
  // Post 1
  'blog.post1.title': {
    en: 'Best Time to Visit Prague: A Seasonal Guide',
    de: 'Beste Reisezeit für Prag: Ein Saisonführer',
  },
  'blog.post1.excerpt': {
    en: "Discover the perfect season to explore Prague based on your preferences. From blooming spring gardens to magical winter markets...",
    de: 'Entdecken Sie die perfekte Jahreszeit, um Prag zu erkunden. Von blühenden Frühlingsgärten bis zu magischen Wintermärkten...',
  },
  'blog.post1.date': {
    en: 'January 15, 2024',
    de: '15. Januar 2024',
...
<p class="lead">Wünschen Sie eine saisonale Privattour, die zu Ihrem Aufenthalt passt? <a href="/contact#contact-title">Kontaktieren Sie mich</a> und ich plane etwas, das Ihrer Zeit und Ihren Interessen entspricht.</p>`
  ...
  'blog.post2.excerpt': {
    ...
    de: 'Eine gehbare Auswahl aus Höfen, Gärten und Cafés, die sich wirklich lokal anfühlen—ohne durch die Stadt zu hetzen.',
  },
  'blog.post2.date': {
    en: 'January 8, 2024',
    de: '8. Januar 2024',
...
<p>Altstädter Ring → Ungelt → Clam-Gallas → Karlsbrücke (Seitenblicke) → Vrtba oder Wallenstein → Kampa → Abschluss am Nationaltheater mit Kaffee. <em>Soll ich Sie führen?</em> <a href="/book?tour=Verstecktes%20Prag#contact-title">Private Tour buchen</a>.</p>`
  ...
  // Post 3 (Night Prague)
  'blog.post3.title': {
    en: 'Prague at Night: A Magical Experience',
    de: 'Prag bei Nacht: Ein magisches Erlebnis',
  },
  'blog.post3.excerpt': {
    en: 'Discover the enchanting beauty of Prague after dark. From illuminated bridges to romantic evening walks, experience the magic of nocturnal Prague...',
    de: 'Entdecken Sie die bezaubernde Schönheit Prags nach Einbruch der Dunkelheit. Von beleuchteten Brücken bis zu romantischen Abendspaziergängen...',
  },
  'blog.post3.date': {
    en: 'January 1, 2024',
    de: '1. Januar 2024',
...
<p class="lead">Buchen Sie eine private <a href="/tours">Nachttour</a> — ich zeige Ihnen die Aussichtspunkte, die den Weg wert sind, und die Fotospots, die noch auf keiner Liste stehen.</p>`
  ...
  'blog.post4.title': {
    en: 'The Jewish Quarter: History and Heritage',
...
<p class="lead">Für einen Besuch, der der Geschichte gerecht wird, <a href="/contact#contact-title">kontaktieren Sie mich</a>. Ich passe Tempo und Tiefe an das an, was Sie suchen.</p>`
  ...
  'blog.post5.title': {
    en: 'Top 21 Instagrammable Places in Prague',
...
<ol>
  ...
  <li><h3>Old Town Square</h3><p>Astronomical Clock details and wide shots at sunrise.</p></li>
  <li><h3>Letná Park</h3><p>River S-curves and bridge panorama.</p></li>
  <li><h3>Vrtba Garden</h3><p>Baroque terraces and city roofs (seasonal).</p></li>
  <li><h3>Mala Strana Alleys</h3><p>Lantern-lit streets and pastel facades.</p></li>
  <li><h3>John Lennon Wall</h3><p>Colorful backdrop with constant change.</p></li>
  <li><h3>Petřín Lookout</h3><p>City skyline with trees and blossom in spring.</p></li>
  <li><h3>Rudolfinum & Riverbank</h3><p>Castle reflections at blue hour.</p></li>
  <li><h3>Municipal House</h3><p>Art Nouveau details and café interiors.</p></li>
  <li><h3>Wallenstein Garden</h3><p>Peacocks, arcades, and the dripstone wall.</p></li>
  <li><h3>Vyšehrad Fortifications</h3><p>Vltava vistas and neo-Gothic spires.</p></li>
  <li><h3>Powder Tower</h3><p>Gothic textures and dramatic perspective.</p></li>
  <li><h3>Clementinum Courtyard</h3><p>Elegant symmetry and stone colonnades.</p></li>
  <li><h3>Strahov Monastery</h3><p>Libraries (with permits) and sweeping views.</p></li>
  <li><h3>Kafka Head</h3><p>Moving mirrors—great for creative reflections.</p></li>
  <li><h3>Dancing House</h3><p>Modern contrast with classic riverfront.</p></li>
  <li><h3>Old Jewish Cemetery</h3><p>Respectful angles—no flash, no posing.</p></li>
  <li><h3>Charles Bridge from Kampa</h3><p>Romantic shots through willows.</p></li>
...
<ol>
  ...
  <li><h3>Altstädter Ring</h3><p>Astronomische Uhr im Detail, Weitwinkel bei Sonnenaufgang.</p></li>
  <li><h3>Letná-Park</h3><p>Flussschleifen und Brückenpanorama.</p></li>
  <li><h3>Vrtba-Garten</h3><p>Barockterrassen und Dächer (saisonal).</p></li>
  <li><h3>Gassen der Kleinseite</h3><p>Laternenlicht und Pastellfassaden.</p></li>
  <li><h3>John-Lennon-Mauer</h3><p>Bunte Kulisse im Wandel.</p></li>
  <li><h3>Petřín-Aussicht</h3><p>Stadtbild mit Bäumen, Blüte im Frühling.</p></li>
  <li><h3>Rudolfinum & Ufer</h3><p>Schlossreflexe zur Blauen Stunde.</p></li>
  <li><h3>Gemeindehaus</h3><p>Jugendstil-Details und Café-Interieurs.</p></li>
  <li><h3>Wallenstein-Garten</h3><p>Pfauen, Arkaden, Tropfsteinwand.</p></li>
  <li><h3>Vyšehrad</h3><p>Vltava-Blicke und neugotische Türme.</p></li>
  <li><h3>Pulverturm</h3><p>Gotische Texturen, dramatische Perspektive.</p></li>
  <li><h3>Klementinum-Hof</h3><p>Elegante Symmetrie und Säulengänge.</p></li>
  <li><h3>Strahov-Kloster</h3><p>Bibliotheken (mit Genehmigung) und Panorama.</p></li>
  <li><h3>Kafka-Kopf</h3><p>Spiegelungen in Bewegung.</p></li>
  <li><h3>Das Tanzende Haus</h3><p>Moderne im Kontrast zur klassischen Uferfront.</p></li>
  <li><h3>Alter Jüdischer Friedhof</h3><p>Respektvolle Winkel—kein Blitz, keine Posen.</p></li>
  <li><h3>Karlsbrücke von Kampa</h3><p>Romantische Bilder durch Weiden.</p></li>
...
<p class="lead">Möchten Sie eine Foto-Route von Sonnenaufgang bis Nacht, die zu Ihrem Plan passt? <a href="/contact#contact-title">Schreiben Sie mir</a> und ich stelle eine private Tour zusammen.</p>`
  ...
  'blog.post6.excerpt': {
    ...
    de: 'Folgen Sie den Spuren Václav Havels durch Prag—Schauplätze der Samtenen Revolution, Bürgerforen, Theater und Cafés, die den Weg zur Freiheit prägten.',
  },
  'blog.post6.date': {
    en: 'October 18, 2025',
    de: '18. Oktober 2025',
...
<h3>Café Slavia und Olga</h3>
<p>Im legendären <strong>Café Slavia</strong> traf Havel Künstler, Politiker und seine große Liebe <em>Olga</em>. Ihre Verbundenheit, geerdet im Alltäglichen, trug sein außergewöhnliches öffentliches Leben.</p>
<h3>Dissidentenjahre und Theater</h3>
...
<h3>Practical Notes</h3>
<ul>
  <li>Stairs only; the climb is moderate but steady.</li>
  <li>Weather can affect visibility—clear afternoons are ideal.</li>
  <li>Combine with an Old Town walk and a <a href="/tours">Charles Bridge route</a>.</li>
</ul>
...
<h3>Praktische Hinweise</h3>
<ul>
  <li>Nur Treppen; der Aufstieg ist moderat, aber stetig.</li>
  <li>Wetter beeinflusst die Sicht—klare Nachmittage sind ideal.</li>
  <li>Kombinierbar mit Altstadtgang und <a href="/tours">Karlsbrücken-Route</a>.</li>
</ul>
<p class="lead">Wünschen Sie eine maßgeschneiderte Runde mit Zeitfenstern und gutem Licht? <a href="/contact#contact-title">Schreiben Sie mir</a>.</p>`
  },
  ...
  'blog.post9.excerpt': {
    ...
    de: 'Konzerte, Galerien, Moldauspaziergänge, warme Cafés—plus realistische Tipps zu Wetter und Zeiten. Ihr entspannter November-Plan in Prag.',
  },
  'blog.post9.date': {
    en: 'October 16, 2025',
    de: '16. Oktober 2025',
...
<p class="lead">Wünschen Sie einen ruhigen Plan mit Karten und Ticketzeiten? <a href="/contact#contact-title">Fragen Sie mich</a> und ich gestalte Ihren November.</p>`
  ...
  // Post 10 (Gardens)
  'blog.post10.title': {
    en: 'Top Prague Gardens to Visit',
    de: 'Die schönsten Prager Gärten',
  },
  'blog.post10.excerpt': {
    en: 'From Vrtba to Wallenstein, here are the prettiest gardens in Prague—plus timing tips and route ideas.',
    de: 'Vom Vrtba- bis zum Wallenstein-Garten—die schönsten Gärten Prags mit Zeit- und Routenideen.',
  },
  'blog.post10.date': {
    en: 'October 18, 2025',
    de: '18. Oktober 2025',
...
<ul>
  ...
  <li><strong>Great Fürstenberg Terrace:</strong> Long steps with elegant vistas to Old Town.</li>
</ul>
<h3>Classic Favorites</h3>
<ul>
  <li><strong>Vrtba Garden:</strong> Baroque geometry and city panorama (seasonal).</li>
  <li><strong>Wallenstein Garden:</strong> Peacocks, arcades, and the dripstone wall.</li>
</ul>
<h3>Practical Notes</h3>
<ul>
  <li>Seasonal openings; check tickets and closures.</li>
  <li>Morning or golden hour for softer light.</li>
  <li>Combine with Kampa and the riverside for a calm day.</li>
</ul>
<p class="lead">Prefer a private route with garden timings and shortcuts? <a href="/contact#contact-title">Message me</a>.</p>`,
    de: `<h2>Die schönsten Gartenblicke</h2>
<p>Prags Gärten bilden ein stilles Geflecht durch die Stadt—barocke Terrassen, Palaststufen und Wiesen am Fluss. So sehen Sie das Beste—mit Zeit und Ruhe.</p>
<h3>Palastgärten unter der Prager Burg</h3>
<ul>
  <li><strong>Ledebour- & Kleine Paläste:</strong> Terrassen, formale Muster—ideal für Fotos.</li>
  <li><strong>Große Fürstenberg-Terrasse:</strong> Lange Stufen mit Blicken zur Altstadt.</li>
</ul>
<h3>Klassische Favoriten</h3>
<ul>
  <li><strong>Vrtba-Garten:</strong> Barocke Geometrie und Panorama (saisonal).</li>
  <li><strong>Wallenstein-Garten:</strong> Pfauen, Arkaden, Tropfsteinwand.</li>
</ul>
<h3>Praktische Hinweise</h3>
<ul>
  <li>Saisonale Öffnungen; Tickets und Schließungen prüfen.</li>
  <li>Morgen oder Goldene Stunde für weiches Licht.</li>
  <li>Kombinieren Sie mit Kampa und dem Ufer für einen ruhigen Tag.</li>
</ul>
<p class="lead">Wünschen Sie eine private Route mit Gartentimings und Abkürzungen? <a href="/contact#contact-title">Schreiben Sie mir</a>.</p>`
  },
  ...
  'blog.post11.excerpt': {
    ...
    de: 'Sanft oberhalb der Kleinseite: ruhige Blicke, legendäre Bibliothek (mit Genehmigung) und ein klassischer Prager Klosterweg.',
  },
  'blog.post11.date': {
    en: 'October 18, 2025',
    de: '18. Oktober 2025',
...
<ul>
  ...
  <li><strong>Monastery ridge:</strong> Quiet paths to rooftops and castle silhouettes.</li>
</ul>
<h3>Library & Lore</h3>
<ul>
  <li><strong>Philosophical & Theological Halls:</strong> Access and photography <strong>often by permit only</strong>.</li>
  <li><strong>Strahov Brewery:</strong> A traditional stop to warm up after the walk.</li>
</ul>
<div class="did-you-know"><h4>Did you know?</h4><p>Collections include <strong>globes and curiosities</strong>, cousin in spirit to the <a href="/blog/klementinum-baroque-library-prague">Klementinum Baroque Library</a>.</p></div>
<h3>Route Ideas</h3>
<p>Pair Strahov with <a href="/blog/top-prague-gardens-to-visit">palace and monastery gardens</a>, or descend via <em>Malá Strana</em> into <a href="/blog/top-21-instagrammable-places-in-prague">classic photo spots</a>.</p>
<h3>Practical Tips</h3>
<ul>
  <li>Check <strong>opening hours</strong> for the basilica and library; library access often guided or by permit.</li>
...
<ul>
  <li><strong>Petřín-Terrassen:</strong> Sanfte Hänge mit Stadtblicken—bei jedem Licht schön.</li>
  <li><strong>Klosterkamm:</strong> Ruhige Wege zu Dächern und Schloss-Silhouetten.</li>
</ul>
<h3>Bibliothek & Legenden</h3>
<ul>
  <li><strong>Philosophischer & Theologischer Saal:</strong> Zutritt und Fotografie <strong>oft nur mit Genehmigung</strong>.</li>
  <li><strong>Strahov-Brauerei:</strong> Traditioneller Stopp zum Aufwärmen nach dem Gang.</li>
</ul>
<div class="did-you-know"><h4>Wussten Sie schon?</h4><p>Zu den Sammlungen gehören <strong>Globen und Kuriositäten</strong>, verwandt in Geist und Atmosphäre mit der <a href="/blog/klementinum-baroque-library-prague">Barockbibliothek im Klementinum</a>.</p></div>
<h3>Routenideen</h3>
<p>Kombinieren Sie Strahov mit <a href="/blog/top-prague-gardens-to-visit">Palast- und Klostergärten</a> zu einer malerischen Runde, oder steigen Sie über die <em>Kleinseite</em> ab zu <a href="/blog/top-21-instagrammable-places-in-prague">ikonischen Fotospots</a>.</p>
<h3>Praktische Tipps</h3>
<ul>
  <li><strong>Öffnungszeiten</strong> der Basilika und Bibliothek prüfen; Bibliothekszugang oft nur mit Führung oder Genehmigung.</li>
  <li>Morgen oder später Nachmittag bieten sanftes Licht und weniger Besucher.</li>
...
<p class="lead">Möchten Sie eine ruhige <strong>Strahov + Burg</strong>-Route mit den besten Aussichtspunkten? <a href="/book?tour=Individuelle%20Privattour#contact-title">Private Tour buchen</a>—ich passe den Spaziergang an Ihr Tempo an.</p>`
  ...
  'blog.post12.excerpt': {
    ...
    de: 'Die vollständige Kafka-Route in Prag: Geburtshaus, Tafeln, Cafés, Museum, Goldenes Gässchen u. mehr—mit Zeiten, Karte und in einem halben Tag machbar.',
  },
  'blog.post12.date': {
    en: 'October 19, 2025',
    de: '19. Oktober 2025',
...
<ul>
  ...
  <li>Jewish Quarter + statue: 30–45 min</li>
  <li>Optional: Rotating Head (Quadrio): 10–15 min</li>
  <li>Castle Golden Lane add-on: 45–60 min (ticketed)</li>
  <li>Cafés (Louvre/Slavia): 20–30 min break</li>
  <li>Kafka Museum: 45–60 min</li>
  <li>Walking links between stops: ~30–45 min total</li>
  </ul>
<div class="blog-cta-box">
  <h3>Open the Kafka Route in Google Maps</h3>
  <p>Birthplace (Týn) → Old Town plaques → Jewish Quarter statue → Rotating Head (Quadrio) → Golden Lane → Cafés (Louvre/Slavia) → Kafka Museum</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" target="_blank" rel="noopener" href="https://www.google.com/maps/dir/?api=1&origin=Old+Town+Square,+Prague&destination=Franz+Kafka+Museum,+Ciheln%C3%A1+2b,+110+00+Praha+1&travelmode=walking&waypoints=T%C3%BDnsk%C3%BD+chram|Charles+University,+Prague|Statue+of+Franz+Kafka,+Du%C5%A1n%C3%A1|Head+of+Franz+Kafka,+Prague|Golden+Lane,+Prague+Castle|Caf%C3%A9+Louvre,+N%C3%A1rodn%C3%AD+22|Caf%C3%A9+Slavia,+Smetanovo+n%C3%A1b%C5%99e%C5%BE%C3%AD+1">Open in Google Maps</a>
    <a class="btn btn-outline" href="/book?tour=Kafka%20Itinerary#contact-title">Book a guided Kafka tour</a>
  </div>
</div>
<div class="blog-cta-box">
...
<p class="lead"><strong>Franz Kafka (1883–1924)</strong> schrieb in einem Prag zwischen <em>deutscher, tschechischer und jüdischer</em> Kultur. Mit dieser <strong>Itinerar</strong> sehen Sie alle wichtigen Kafka-Orte in einem halben Tag.</p>
<h3>Stopp 1 — Geburtshaus bei der Teynkirche (Altstadt)</h3>
<p>Das ursprüngliche Haus existiert nicht mehr, doch der <strong>Ort an der Teynkirche</strong> markiert Kafkas frühe Jahre, nur Schritte vom Altstädter Ring.</p>
<h3>Stopp 2 — Tafeln & Karlsuniversität</h3>
<p>Finden Sie <strong>Gedenktafeln und Adressen</strong>, an denen Kafka lebte oder studierte—rund um die <strong>Karlsuniversität</strong> und das Altstadtgitter.</p>
<h3>Stopp 3 — Kafka-Statue & Kontext Jüdisches Viertel</h3>
<p>Besuchen Sie die <strong>Kafka-Statue</strong> nahe der Spanischen Synagoge und fügen Sie die <strong>Stätten des Jüdischen Museums</strong> für den Zeitkontext hinzu.</p>
<div class="blog-inline-image"><img src="/images/blog-kafka-2.jpg" alt="Franz Kafka – Rotierender Kopf von David Černý nahe Národní třída" loading="lazy" /><div class="image-credit">Franz Kafka – Rotierender Kopf von David Černý (nahe Národní třída / Quadrio)</div></div>
<h3>Optional — „Rotierender Kopf“ (David Černý)</h3>
<p>Die kinetische Skulptur von <strong>David Černý</strong>—der <em>Rotierende Kopf</em>—steht am <strong>Quadrio</strong> nahe der <strong>Národní třída</strong>. Leicht zwischen Altstadt und Café‑Stopps einzubauen.</p>
<h3>Stopp 4 — Kafkas Häuschen im Goldenen Gässchen (Burg)</h3>
<p>Ein kleines Haus im <strong>Goldenen Gässchen</strong> diente als Schreibrefugium—ideal kombinierbar mit einem <a href="/tours">Burgspaziergang</a>.</p>
<h3>Stopp 5 — Cafés: Louvre & Slavia</h3>
<p>Klassische Cafés an der Národní—<strong>Café Louvre</strong> und <strong>Café Slavia</strong>—knüpfen an Prags literarische Kreise an. Perfekte Pausenstopps.</p>
<h3>Stopp 6 — Franz-Kafka-Museum (Kleinseite)</h3>
<p>Am Fluss bietet das <strong>Kafka-Museum</strong> eine Stunde Handschriften, Fotos und Medien—ideal zum Abschluss des Rundgangs.</p>
<div class="did-you-know"><h4>Wussten Sie schon?</h4><p>Kafkas <em>Tagesjob</em> bei der <strong>Arbeiter-Unfallversicherungsanstalt</strong> prägte seine Themen von Bürokratie und Moderne.</p></div>
<h3>Zeitplanung & Route (3–4 Stunden)</h3>
<ul>
  <li>Altstadtkern (Geburtshaus, Tafeln): 45–60 Min</li>
  <li>Jüdisches Viertel + Statue: 30–45 Min</li>
  <li>Optional: Rotierender Kopf (Quadrio): 10–15 Min</li>
  <li>Burg/Goldenes Gässchen optional: 45–60 Min (Ticket)</li>
  <li>Cafés (Louvre/Slavia): 20–30 Min Pause</li>
  <li>Kafka-Museum: 45–60 Min</li>
  <li>Wege zwischen Stopps: ca. 30–45 Min</li>
  </ul>
<div class="blog-cta-box">
  <h3>Kafka-Route in Google Maps öffnen</h3>
  <p>Geburtsort (Teyn) → Altstadt-Tafeln → Statue im Jüdischen Viertel → Rotierender Kopf (Quadrio) → Goldenes Gässchen → Cafés (Louvre/Slavia) → Kafka-Museum</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" target="_blank" rel="noopener" href="https://www.google.com/maps/dir/?api=1&origin=Altst%C3%A4dter+Ring,+Prag&destination=Franz+Kafka+Museum,+Ciheln%C3%A1+2b,+110+00+Praha+1&travelmode=walking&waypoints=Teynkirche|Karlsuniversit%C3%A4t,+Prag|Kafka-Statue,+Du%C5%A1n%C3%A1|Head+of+Franz+Kafka,+Prague|Goldenes+G%C3%A4sschen,+Prager+Burg|Caf%C3%A9+Louvre,+N%C3%A1rodn%C3%AD+22|Caf%C3%A9+Slavia,+Smetanovo+n%C3%A1b%C5%99e%C5%BE%C3%AD+1">In Google Maps öffnen</a>
    <a class="btn btn-outline" href="/book?tour=Kafka%20Itinerary#contact-title">Geführte Kafka-Tour buchen</a>
  </div>
</div>
<div class="blog-cta-box">
  <h3>Möchten Sie eine ruhige Kafka-Route mit allen Highlights?</h3>
  <p>Mit Rotierendem Kopf, versteckten Altstadt-Tafeln und optimalen Museumszeiten—genau in <strong>Ihrem</strong> Tempo. <a href="/book?tour=Kafka%20Itinerary#contact-title">Private Tour buchen</a>—ich passe Route, Zeiten und Tickets an.</p>
</div>
<p>Machen Sie es zu Fuß oder buchen Sie eine <a href="/book?tour=Kafka%20Itinerary#contact-title">Kafka-Privatführung</a> mit Navigation, Tickets und Kontext.</p>`
  },
  ...
  'blog.post13.excerpt': {
    ...
    de: 'Prag leuchtet im Winter in warmem Licht: stille Gassen, magische Ausblicke. Hier sind 12 der schönsten Altstadt-Perspektiven—fußläufig, fotogen und behaglich.',
  },
  'blog.post13.date': {
    en: 'October 25, 2025',
    de: '25. Oktober 2025',
...
<div class="blog-cta-box">
  ...
  'blog.post21.excerpt': {
    ...
    de: 'Dan Brown schrieb angeblich über 10.000 Seiten, bevor er seinen neuen Roman auf weniger als 700 verdichtete. Diese obsessive Suche nach verborgener Wahrheit — kodierte Symbole, vergrabene Geschichte, Städte, die einem ins Gesicht lügen — ist genau das, was Prag seit tausend Jahren tut.',
  },
  'blog.post21.date': {
    en: 'April 13, 2026',
    de: '13. April 2026',
...
<div class="blog-cta-box">
  ...
  <p>Ask Zuza Prague Tours about a private walk tuned to Castle esoterica, the Jewish Quarter and Golem ground, the clock face, and the Klementinum — paced for readers, not generic sightseeing.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Hidden%20Prague%20History%20Tour#contact-title">Book a tour</a>
    <a class="btn btn-outline" href="/contact#contact-title">Ask a question</a>
  </div>
</div>
...
<div class="blog-cta-box">
  ...
  <p>Fragen Sie Zuza Prague Tours nach einem privaten Rundgang zu Burg-Esoterik, Jüdischem Viertel und Golem-Boden, Uhrenblatt und Klementinum — im Tempo für Leser, nicht für Standard-Sightseeing.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Verborgene%20Geschichte%20Prag#contact-title">Tour buchen</a>
    <a class="btn btn-outline" href="/contact#contact-title">Frage stellen</a>
  </div>
</div>
...
<div class="blog-cta-box">
  ...
  'blog.post15.excerpt': {
    ...
    de: 'Kirschblüten auf dem Petřínhügel, Ostermärkte auf dem Altstädter Ring und das Prager Frühling Musikfestival — alles, was Sie für einen Prag-Besuch im Frühling wissen müssen.',
  },
  'blog.post15.date': {
    en: 'April 1, 2026',
    de: '1. April 2026',
...
<div class="blog-cta-box">
  ...
  'blog.post16.excerpt': {
    ...
    de: 'Flussuferkneipen an der Náplavka, Open-Air-Kinos, Sonnenuntergangs-Rooftops und morgendliche Spaziergänge auf der Karlsbrücke — Ihr kompletter Leitfaden für Prag im Sommer.',
  },
  'blog.post16.date': {
    en: 'March 15, 2026',
    de: '15. März 2026',
...
<div class="blog-cta-box">
  ...
  'blog.post17.excerpt': {
    ...
    de: 'Von September bis November zeigt Prag seine kinofilmreifste Seite: bernsteinfarbenes Laub in Stromovka, das Signal Festival, das die Altstadt erhellt, und die ersten Weihnachtsmarktstände im November.',
  },
  'blog.post17.date': {
    en: 'March 1, 2026',
    de: '1. März 2026',
...
<div class="blog-cta-box">
  ...
  'blog.post18.excerpt': {
    ...
    de: 'Von Svíčková und Tankbier bis zum Náplavka-Samstagmarkt und Vinohrady-Weinbars — ein Einheimischenführer zum guten Essen und Trinken in Prag.',
  },
  'blog.post18.date': {
    en: 'February 15, 2026',
    de: '15. Februar 2026',
  ...
  'blog.post18.content': {
    en: `<h2>Prague Food Guide: What to Eat, Where to Go & Local Favourites</h2>
<p class="lead">Czech cuisine is honest, hearty, and deeply rooted in Central European tradition. But modern Prague has layered craft beer bars, natural wine shops, Vietnamese markets, and inventive fine dining on top of that tradition. Here's how to eat well — from street food to white tablecloths.</p>

<h2>The Czech Classics: What to Try First</h2>
<h3>Svíčková na smetaně</h3>
<p>The national comfort dish: slow-braised beef sirloin in a root-vegetable cream sauce, served with bread dumplings (knedlíky), whipped cream, and cranberry jam. Every Czech family has a version. In Prague, seek it in traditional hospody (pubs) rather than tourist restaurants.</p>

<h3>Vepřo knedlo zelo</h3>
<p>Roast pork, bread dumplings, sauerkraut. Simple, filling, deeply satisfying. The quality of the dumpling — soft inside, slightly chewy crust — tells you everything about the kitchen.</p>

<h3>Smažený sýr</h3>
<p>Breaded and fried Edam cheese, served with tartare sauce. A beloved Czech fast food found at street kiosks and pubs alike. Try it at least once.</p>

<h3>Knedlíky (Dumplings)</h3>
<p>Bread or potato dumplings appear alongside almost every main dish. They're the foundation that soaks up the sauce. Bread dumplings (houskové) are the most common; potato (bramborové) are denser and earthier.</p>

<h2>Czech Beer: A Culture, Not Just a Drink</h2>
<p>The Czech Republic has the highest per-capita beer consumption globally and has been brewing since the 12th century. Key things to know:</p>
<ul>
  <li><strong>Pilsner Urquell</strong> (from Plzeň) — the original pilsner, best served unfiltered (nefiltrovaný) where available.</li>
  <li><strong>Kozel, Gambrinus, Budvar</strong> — quality everyday lagers found across the city.</li>
  <li><strong>Craft beer scene</strong> — Prague's microbrewery explosion means rotating taps in dozens of bars. Try Matuška, Pivovar Maják, or Vinohradský pivovar.</li>
  <li><strong>Tankové pivo</strong> — tank beer served directly from unpasteurised tanks. Fresher and creamier than bottle or keg.</li>
</ul>

<h2>Where to Eat Well in Prague</h2>
<h3>Lokál (multiple locations)</h3>
<p>The gold standard for traditional Czech food and tank Pilsner Urquell. Always busy, always consistent. Book ahead for dinner.</p>

<h3>Naše Maso (Dlouhá street)</h3>
<p>A butcher-deli hybrid beloved by locals. Outstanding tartar steak and cold cuts to eat standing at a counter. Lunch hours only.</p>

<h3>Vinohrady & Žižkov neighbourhood</h3>
<p>The best area for independent restaurants, natural wine bars, and neighbourhood dining without tourist pricing. Try restaurants on Mánesova, Blanická, and around Náměstí Míru.</p>

<h2>Street Food & Markets</h2>
<ul>
  <li><strong>Náplavka Farmers' Market</strong> (Saturdays) — artisan bread, cheese, charcuterie, and street food from small Czech producers.</li>
  <li><strong>Pražská tržnice (Prague Market, Holešovice)</strong> — a sprawling indoor-outdoor market with Vietnamese food stalls, butchers, and produce. Authentic, cheap, and far from tourist zones.</li>
  <li><strong>Trdelník</strong> — the chimney pastry is everywhere in the tourist centre. It's not traditional Czech, but it's warm and satisfying on a cold day.</li>
</ul>

<h2>Practical Food Tips</h2>
<ul>
  <li>Lunch (11:00–14:00) is when Czech kitchens shine — many restaurants offer lunch menus (denní menu) at excellent prices.</li>
  <li>Tourist-area restaurants cluster around Old Town Square and Charles Bridge. Walk two streets away for better value.</li>
  <li>Czech restaurants commonly add bread to the table automatically and charge for it — you can decline.</li>
  <li>Tipping: 10% is appreciated and expected for table service.</li>
</ul>

<div class="blog-cta-box">
  <h3>Eat Prague Like a Local</h3>
  <p>I take my guests to the real kitchens — the pub where the owner still makes svíčková from her mother's recipe, the market that opens before tourist Prague wakes up. Ask me to plan a food walk.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Food%20Walk%20Prague#contact-title">Book a food walk</a>
    <a class="btn btn-outline" href="/contact#contact-title">Ask a question</a>
  </div>
</div>`,
    de: `<h2>Prag Kulinarikführer: Was essen, wo hingehen & lokale Lieblinge</h2>
<p class="lead">Die tschechische Küche ist ehrlich, herzhaft und tief in der mitteleuropäischen Tradition verwurzelt. Aber das moderne Prag hat Craft-Beer-Bars, Naturweinkeller, vietnamesische Märkte und einfallsreiche Spitzenküche auf diese Tradition aufgeschichtet. So essen Sie gut — von Straßenessen bis zu weißen Tischdecken.</p>

<h2>Die tschechischen Klassiker: Was Sie zuerst probieren sollten</h2>
<h3>Svíčková na smetaně</h3>
<p>Das nationale Wohlfühlgericht: langsam geschmortes Rinderfilet in einer Wurzelgemüse-Sahnesoße, serviert mit Knödeln, Schlagsahne und Preiselbeerkonfitüre. Jede tschechische Familie hat ihr eigenes Rezept. In Prag finden Sie es am besten in traditionellen Hospody (Kneipen) statt in Touristenrestaurants.</p>

<h3>Vepřo knedlo zelo</h3>
<p>Schweinebraten, Knödel, Sauerkraut. Einfach, sättigend, zutiefst befriedigend. Die Qualität des Knödels — weich innen, leicht zähe Kruste — verrät alles über die Küche.</p>

<h3>Smažený sýr</h3>
<p>Panierter und gebratener Edamer Käse, serviert mit Tatarsoße. Ein beliebtes tschechisches Fast Food an Straßenkiosken und in Kneipen. Mindestens einmal probieren.</p>

<h3>Knedlíky (Knödel)</h3>
<p>Brot- oder Kartoffelknödel begleiten fast jedes Hauptgericht. Sie sind das Fundament, das die Soße aufsaugt. Brotknödel (houskové) sind die häufigsten; Kartoffelknödel (bramborové) sind dichter und erdiger.</p>

<h2>Tschechisches Bier: Eine Kultur, nicht nur ein Getränk</h2>
<p>Die Tschechische Republik hat den höchsten Pro-Kopf-Bierkonsum weltweit und braut seit dem 12. Jahrhundert. Das Wichtigste:</p>
<ul>
  <li><strong>Pilsner Urquell</strong> (aus Plzeň) — das originale Pilsner, am besten unfiltriert (nefiltrovaný) wo verfügbar.</li>
  <li><strong>Kozel, Gambrinus, Budvar</strong> — hochwertige Alltagslager in der ganzen Stadt.</li>
  <li><strong>Craft-Beer-Szene</strong> — Prags Mikrobrauerei-Explosion bedeutet rotierende Zapfhähne in Dutzenden von Bars. Probieren Sie Matuška, Pivovar Maják oder Vinohradský pivovar.</li>
  <li><strong>Tankové pivo</strong> — Tankbier direkt aus unpasteurisierten Tanks. Frischer und cremiger als Flasche oder Fass.</li>
</ul>

<h2>Wo man in Prag gut isst</h2>
<h3>Lokál (mehrere Standorte)</h3>
<p>Der Goldstandard für traditionelle tschechische Küche und Tank-Pilsner-Urquell. Immer voll, immer konstant. Für das Abendessen vorbestellen.</p>

<h3>Naše Maso (Dlouhá-Straße)</h3>
<p>Ein Metzger-Deli-Hybrid, geliebt von Einheimischen. Hervorragendes Tatar und Aufschnitt zum Stehessen an der Theke. Nur zu Mittagszeiten geöffnet.</p>

<h3>Stadtviertel Vinohrady & Žižkov</h3>
<p>Das beste Viertel für unabhängige Restaurants, Naturweinbars und Nachbarschaftsgastronomie ohne Touristenpreise. Probieren Sie Restaurants an der Mánesova, Blanická und rund um den Náměstí Míru.</p>

<h2>Straßenessen & Märkte</h2>
<ul>
  <li><strong>Náplavka Bauernmarkt</strong> (samstags) — handwerkliches Brot, Käse, Charcuterie und Straßenessen von kleinen tschechischen Erzeugern.</li>
  <li><strong>Pražská tržnice (Prager Markt, Holešovice)</strong> — ein weitläufiger Indoor-Outdoor-Markt mit vietnamesischen Essensständen, Metzgern und Produkten. Authentisch, günstig und weit von Touristenzonen entfernt.</li>
  <li><strong>Trdelník</strong> — das Schornsteingeback ist überall im Touristenzentrum. Es ist keine traditionelle tschechische Spezialität, aber an einem kalten Tag warm und befriedigend.</li>
</ul>

<h2>Praktische Tipps zum Essen</h2>
<ul>
  <li>Mittagessen (11:00–14:00 Uhr) ist die Zeit, wenn tschechische Küchen glänzen — viele Restaurants bieten Mittagsmenüs (denní menu) zu hervorragenden Preisen an.</li>
  <li>Restaurants in Touristengebieten rund um den Altstädter Ring und die Karlsbrücke sind nicht unbedingt schlecht, aber immer teurer. Zwei Straßen weiter gehen für besseres Preis-Leistungs-Verhältnis.</li>
  <li>Tschechische Restaurants stellen oft automatisch Brot auf den Tisch und berechnen es — man kann ablehnen.</li>
  <li>Trinkgeld: 10 % werden bei Tischservice geschätzt und erwartet.</li>
</ul>

<div class="blog-cta-box">
  <h3>Prag wie ein Einheimischer essen</h3>
  <p>Ich führe meine Gäste in die echten Küchen — die Kneipe, wo der Inhaber noch svíčková nach dem Rezept seiner Mutter kocht, der Markt, der öffnet, bevor das touristische Prag aufwacht. Bitten Sie mich, einen Kulinarik-Spaziergang zu planen.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Kulinarik-Spaziergang%20Prag#contact-title">Kulinarik-Tour buchen</a>
    <a class="btn btn-outline" href="/contact#contact-title">Frage stellen</a>
  </div>
</div>`,
  },
  ...
  'blog.post19.excerpt': {
    ...
    de: 'Die größte alte Burganlage der Welt — und die meisten Besucher sehen nur 10 % davon. So navigieren Sie durch den Veitsdom, das Goldene Gässchen, den Königlichen Garten und alles dazwischen.',
  },
  'blog.post19.date': {
    en: 'February 1, 2026',
    de: '1. Februar 2026',
  ...
  'blog.post19.content': {
    en: `<h2>Prague Castle: The Complete Visitor's Guide</h2>
<p class="lead">Prague Castle is the largest ancient castle complex in the world by area — over 70,000 square metres of palaces, gardens, churches, galleries, and history spanning 1,100 years. Most visitors see 10% of it. This guide helps you see the right 10% — or much more if you have the time.</p>

<h2>What's Inside: The Key Sites</h2>
<h3>St. Vitus Cathedral</h3>
<p>The spiritual and architectural heart of Prague. Construction began in 1344 and was completed only in 1929 — nearly 600 years of building. Don't miss the <strong>Chapel of St. Wenceslas</strong> (walls inlaid with semi-precious stones), the <strong>stained glass windows</strong> (including one by Alfons Mucha), and the crypt with Bohemian kings. Free to enter the nave; paid ticket for the full interior and tower climb.</p>

<h3>Old Royal Palace (Starý královský palác)</h3>
<p>Home to the <strong>Vladislav Hall</strong> — a late Gothic masterpiece so large that jousting tournaments were held inside. The Bohemian Chancellery here was where the Second Defenestration of Prague happened in 1618, igniting the Thirty Years' War.</p>

<h3>St. George's Basilica</h3>
<p>The oldest surviving church in the castle complex, founded in 920. Its striking Baroque facade hides a remarkably austere and beautiful Romanesque interior — a quiet contrast to St. Vitus Cathedral.</p>

<h3>Golden Lane (Zlatá ulička)</h3>
<p>Colourful miniature houses built into the castle fortification wall in the 16th century. Franz Kafka lived at No. 22 briefly in 1916–17. Today the houses contain exhibits on castle life through the centuries.</p>

<h3>Castle Gardens</h3>
<p>The <strong>Royal Garden</strong> (north side, with the Renaissance Ball Game Hall) and the <strong>South Gardens</strong> (a sequence of terraces with city views) are both extraordinary. The South Gardens connect down to the Malá Strana neighbourhood.</p>

<h2>Tickets, Hours & Practical Logistics</h2>
<p>The castle grounds are free to enter. Tickets are required for individual monuments:</p>
<ul>
  <li><strong>Circuit A</strong> — all major sights including the castle history exhibition</li>
  <li><strong>Circuit B</strong> — St. Vitus Cathedral interior, Old Royal Palace, St. George's Basilica, Golden Lane</li>
  <li>Opening hours: generally 09:00–17:00 (winter) and 09:00–18:00 (summer); check the official website for current hours</li>
  <li>Buy tickets online to avoid queuing at the box office</li>
</ul>

<h2>Best Times to Visit</h2>
<ul>
  <li><strong>Before 09:30:</strong> the courtyards are quiet and photography is unrestricted by crowds</li>
  <li><strong>Tuesday–Thursday:</strong> noticeably less busy than weekends</li>
  <li><strong>After 16:00:</strong> many day-trippers leave; the light on St. Vitus turns golden</li>
  <li><strong>Winter:</strong> snow-dusted courtyards are extraordinary — and almost empty</li>
</ul>

<h2>Getting There</h2>
<ul>
  <li><strong>Tram 22</strong> to Pražský hrad — deposits you directly at the gate</li>
  <li><strong>Walk from Malostranské náměstí</strong> — the classic route up Nerudova street (steep but beautiful)</li>
  <li><strong>Walk from Pohořelec</strong> (via Strahov) — a longer, less-crowded approach via the monastery</li>
</ul>

<h2>Practical Tips</h2>
<ul>
  <li>Allow 2–4 hours minimum for the key circuit</li>
  <li>Wear comfortable shoes — cobblestones and steps across a large area</li>
  <li>The changing of the guard happens on the hour at the First Courtyard; noon ceremony (with band) is the most elaborate</li>
  <li>Bag checks at the main gate — arrive a few minutes early if you have a timed ticket</li>
</ul>

<div class="blog-cta-box">
  <h3>See the Castle With a Guide Who Knows Its Stories</h3>
  <p>The architecture is stunning — but it's the 1,100 years of stories behind it that make a castle visit unforgettable. Let me take you inside the history.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Prague%20Castle%20Tour#contact-title">Book a castle tour</a>
    <a class="btn btn-outline" href="/contact#contact-title">Ask a question</a>
  </div>
</div>`,
    de: `<h2>Prager Burg: Der vollständige Besucherführer</h2>
<p class="lead">Die Prager Burg ist die größte alte Burganlage der Welt nach Fläche — über 70.000 Quadratmeter Paläste, Gärten, Kirchen, Galerien und Geschichte, die sich über 1.100 Jahre erstreckt. Die meisten Besucher sehen 10 % davon. Dieser Leitfaden hilft Ihnen, die richtigen 10 % zu sehen — oder viel mehr, wenn Sie die Zeit haben.</p>

<h2>Was es gibt: Die wichtigsten Sehenswürdigkeiten</h2>
<h3>Veitsdom</h3>
<p>Das spirituelle und architektonische Herz Prags. Der Bau begann 1344 und wurde erst 1929 abgeschlossen — fast 600 Jahre Bauzeit. Verpassen Sie nicht die <strong>Wenzelkapelle</strong> (Wände mit Halbedelsteinen eingelegt), die <strong>Buntglasfenster</strong> (darunter eines von Alfons Mucha) und die Krypta mit böhmischen Königen. Eintritt ins Schiff kostenlos; Ticket für das vollständige Innere und den Turmaufstieg erforderlich.</p>

<h3>Alter Königspalast (Starý královský palác)</h3>
<p>Heimat der <strong>Wladislawsaal</strong> — ein spätgotisches Meisterwerk, so groß, dass darin Reiterturniere abgehalten wurden. Die Böhmische Kanzlei war der Ort des Zweiten Prager Fenstersturzes im Jahr 1618, der den Dreißigjährigen Krieg entfachte.</p>

<h3>Georgsbasilika</h3>
<p>Die älteste erhaltene Kirche in der Burganlage, gegründet im Jahr 920. Ihre auffällige Barockfassade verbirgt ein bemerkenswert nüchternes und schönes romanisches Inneres — ein ruhiger Kontrast zum Veitsdom.</p>

<h3>Goldenes Gässchen (Zlatá ulička)</h3>
<p>Bunte Miniatürhäuser, die im 16. Jahrhundert in die Burgbefestigungsmauer eingebaut wurden. Franz Kafka wohnte kurz 1916–17 in Nr. 22. Heute zeigen die Häuser Ausstellungen zum Burgalltagsleben durch die Jahrhunderte.</p>

<h3>Burggärten</h3>
<p>Der <strong>Königliche Garten</strong> (Nordseite, mit dem Renaissance-Ballspielhaus) und die <strong>Südgärten</strong> (eine Folge von Terrassen mit Stadtblicken) sind beide außergewöhnlich. Die Südgärten verbinden sich hinunter zum Stadtteil Malá Strana.</p>

<h2>Tickets, Zeiten & praktische Logistik</h2>
<p>Der Burgkomplex ist frei zugänglich. Tickets sind für einzelne Denkmäler erforderlich:</p>
<ul>
  <li><strong>Rundgang A</strong> — alle wichtigen Sehenswürdigkeiten einschließlich Burggeschichtsausstellung</li>
  <li><strong>Rundgang B</strong> — Veitsdom-Inneres, Alter Königspalast, Georgsbasilika, Goldenes Gässchen</li>
  <li>Öffnungszeiten: in der Regel 09:00–17:00 Uhr (Winter) und 09:00–18:00 Uhr (Sommer); aktuelle Zeiten auf der offiziellen Website prüfen</li>
  <li>Tickets online kaufen, um Warteschlangen an der Kasse zu vermeiden</li>
</ul>

<h2>Die besten Besuchszeiten</h2>
<ul>
  <li><strong>Vor 09:30 Uhr:</strong> Die Innenhöfe sind ruhig und Fotografie ist uneingeschränkt</li>
  <li><strong>Dienstag–Donnerstag:</strong> Spürbar weniger belebt als an Wochenenden</li>
  <li><strong>Nach 16:00 Uhr:</strong> Viele Tagesausflügler gehen; das Licht auf dem Veitsdom wird golden</li>
  <li><strong>Winter:</strong> Schneebedeckte Innenhöfe sind außergewöhnlich — und fast leer</li>
</ul>

<h2>Anreise</h2>
<ul>
  <li><strong>Straßenbahn 22</strong> bis Pražský hrad — lässt Sie direkt am Tor aus</li>
  <li><strong>Fußweg vom Malostranské náměstí</strong> — die klassische Route die Nerudova-Straße hinauf (steil, aber schön)</li>
  <li><strong>Fußweg von Pohořelec</strong> (über Strahov) — längerer, weniger überfüllter Zugang über das Kloster</li>
</ul>

<h2>Praktische Tipps</h2>
<ul>
  <li>Mindestens 2–4 Stunden für den Hauptrundgang einplanen</li>
  <li>Bequeme Schuhe tragen — Kopfsteinpflaster und Stufen über eine große Fläche</li>
  <li>Der Wachwechsel findet jede Stunde im Ersten Hof statt; Mittagszeremonie (mit Kapelle) um 12:00 Uhr ist die aufwendigste</li>
  <li>Taschenkontrollen am Haupttor — ein paar Minuten früher ankommen bei Zeitticket</li>
</ul>

<div class="blog-cta-box">
  <h3>Die Burg mit einem Führer erleben, der ihre Geschichten kennt</h3>
  <p>Die Architektur ist atemberaubend — aber es sind die 1.100 Jahre Geschichte dahinter, die einen Burgbesuch unvergesslich machen. Lassen Sie mich Sie in die Geschichte mitnehmen.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Prager%20Burg%20Tour#contact-title">Burgtour buchen</a>
    <a class="btn btn-outline" href="/contact#contact-title">Frage stellen</a>
  </div>
</div>`,
  },
  ...
  'blog.post20.excerpt': {
    ...
    de: 'Eine Knochenkirche, eine Märchenschlossstadt, eine habsburgische Jagdresidenz und ein erschütterndes Holocaust-Mahnmal — sechs unvergessliche Tagesausflüge von Prag mit Zug oder Bus.',
  },
  'blog.post20.date': {
    en: 'January 15, 2026',
    de: '15. Januar 2026',
  ...
  'blog.post20.content': {
    en: `<h2>Best Day Trips from Prague: Kutná Hora, Český Krumlov & More</h2>
<p class="lead">Prague is an exceptional base for Central European day trips. Within 1–3 hours by train or bus, you can reach a UNESCO medieval silver-mining town, a fairy-tale castle town on a river bend, an 18th-century imperial spa, and a haunting memorial to the victims of the Holocaust. Here are the six best day trips from Prague.</p>

<h2>Kutná Hora (1 hour by train)</h2>
<p>Once one of Europe's most important cities thanks to its silver mines, Kutná Hora is now a UNESCO World Heritage Site. Two highlights:</p>
<ul>
  <li><strong>Sedlec Ossuary (Bone Church)</strong> — a small chapel decorated with the bones of approximately 40,000–70,000 people. Haunting, bizarre, and unforgettable. Arrive early to beat tour buses.</li>
  <li><strong>Cathedral of St. Barbara</strong> — a breathtaking late Gothic cathedral begun in 1388, still unfinished when the silver ran out. One of the finest Gothic interiors in Central Europe.</li>
</ul>
<p>How to get there: Direct trains from Praha Hlavní nádraží, approx. 55 minutes.</p>

<h2>Český Krumlov (3 hours by bus or car)</h2>
<p>A UNESCO-listed town wrapped in a horseshoe bend of the Vltava River, dominated by the second-largest castle in the Czech Republic. The old town is beautifully preserved — cobblestone lanes, a Baroque theatre, and castle gardens. Best visited on a weekday in spring or autumn to avoid summer crowds. Direct buses from Na Knížecí bus station, about 3 hours.</p>

<h2>Karlštejn Castle (40 minutes by train)</h2>
<p>The most visited Czech castle after Prague Castle. Emperor Charles IV built it in the 14th century to safeguard the Bohemian crown jewels and holy relics. The approach through the village below the castle is as picturesque as the castle itself. Trains run frequently from Praha Hlavní nádraží.</p>

<h2>Terezín (1 hour by bus)</h2>
<p>A former Habsburg military fortress that became a Nazi concentration camp and ghetto during WWII. The Terezín Memorial is one of the most important Holocaust memorial sites in Central Europe. Allow a full day; the experience is sobering and essential. Buses from Florenc bus station.</p>

<h2>Karlovy Vary (2 hours by bus)</h2>
<p>The most famous of the Bohemian spa towns, known for hot mineral springs, elegant colonnades, and the Karlovy Vary International Film Festival (July). Walk the spa colonnade, drink from the springs (bring a spa cup — it's part of the ritual), and admire the grand 19th-century hotels. Direct buses from Florenc, about 2 hours.</p>

<h2>Konopiště Castle (1 hour by train + short walk)</h2>
<p>The hunting residence of Archduke Franz Ferdinand — whose assassination in 1914 triggered WWI. The interior is preserved almost exactly as he left it, with an extraordinary collection of hunting trophies and weapons. Surrounded by beautiful grounds. Train to Benešov u Prahy, then a 3 km walk or local bus.</p>

<h2>Practical Day Trip Tips</h2>
<ul>
  <li>Czech trains are inexpensive and comfortable — book via <em>cd.cz</em> (Czech Railways).</li>
  <li>For Český Krumlov, buses (RegioJet, FlixBus) are often faster and more direct than trains.</li>
  <li>Start early — most sites open at 09:00 and close 17:00–18:00; arriving at opening avoids coach groups.</li>
  <li>Kutná Hora is easy to do in a half-day; Český Krumlov requires a full day minimum.</li>
</ul>

<div class="blog-cta-box">
  <h3>Make Your Day Trip Count</h3>
  <p>I can arrange private transport and guiding for any of these destinations — so you get the context, the stories, and none of the hassle.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Day%20Trip%20from%20Prague#contact-title">Book a day trip</a>
    <a class="btn btn-outline" href="/contact#contact-title">Ask a question</a>
  </div>
</div>`,
    de: `<h2>Die besten Tagesausflüge von Prag: Kutná Hora, Český Krumlov & mehr</h2>
<p class="lead">Prag ist eine außergewöhnliche Basis für mitteleuropäische Tagesausflüge. Innerhalb von 1–3 Stunden mit Zug oder Bus erreichen Sie eine UNESCO-mittelalterliche Silberbergbaustadt, eine Märchenschlossstadt an einer Flussbiegung, ein kaiserliches Kurbad und ein erschütterndes Holocaust-Mahnmal. Hier sind die sechs besten Tagesausflüge von Prag.</p>

<h2>Kutná Hora (1 Stunde mit dem Zug)</h2>
<p>Einst eine der wichtigsten Städte Europas dank seiner Silberminen, ist Kutná Hora heute ein UNESCO-Weltkulturerbe. Zwei Highlights:</p>
<ul>
  <li><strong>Sedlec Ossarium (Knochenkirche)</strong> — eine kleine Kapelle, dekoriert mit den Knochen von etwa 40.000–70.000 Menschen. Gespenstisch, bizarr und unvergesslich. Früh ankommen, um Reisebussen zuvorzukommen.</li>
  <li><strong>Kathedrale der Heiligen Barbara</strong> — eine atemberaubende spätgotische Kathedrale, 1388 begonnen, noch unfertig als das Silber ausging. Eines der schönsten gotischen Interieurs Mitteleuropas.</li>
</ul>
<p>Anreise: Direktzüge vom Praha Hlavní nádraží, ca. 55 Minuten.</p>

<h2>Český Krumlov (3 Stunden mit Bus oder Auto)</h2>
<p>Eine UNESCO-gelistete Stadt, umschlungen von einer Hufeiseniegung der Moldau, dominiert vom zweitgrößten Schloss der Tschechischen Republik. Die Altstadt ist wunderschön erhalten — Kopfsteinpflastergassen, Barocktheater und Schlossgärten. Am besten werktags im Frühling oder Herbst besuchen, um Sommermassen zu vermeiden. Direktbusse vom Busbahnhof Na Knížecí, ca. 3 Stunden.</p>

<h2>Burg Karlštejn (40 Minuten mit dem Zug)</h2>
<p>Die meistbesuchte tschechische Burg nach der Prager Burg. Kaiser Karl IV. ließ sie im 14. Jahrhundert bauen, um die böhmischen Kronjuwelen und heiligen Reliquien zu schützen. Der Anmarsch durch das Dorf unterhalb ist genauso malerisch wie die Burg selbst. Züge fahren häufig vom Praha Hlavní nádraží.</p>

<h2>Theresienstadt (1 Stunde mit dem Bus)</h2>
<p>Eine ehemalige habsburgische Militärfestung, die im Zweiten Weltkrieg zu einem NS-Konzentrationslager und Ghetto wurde. Die Gedenkstätte Theresienstadt ist eine der wichtigsten Holocaust-Gedenkstätten in Mitteleuropa. Einen ganzen Tag einplanen; die Erfahrung ist ernüchternd und wesentlich. Busse vom Busbahnhof Florenc.</p>

<h2>Karlsbad (2 Stunden mit dem Bus)</h2>
<p>Das bekannteste der böhmischen Kurstädte, bekannt für heiße Mineralquellen, elegante Kolonnaden und das Internationale Filmfestival Karlovy Vary (Juli). Spazieren Sie die Kurkolonnade entlang, trinken Sie aus den Quellen (Kurbecher mitbringen — es ist Teil des Rituals) und bewundern Sie die prächtigen Hotels des 19. Jahrhunderts. Direktbusse von Florenc, ca. 2 Stunden.</p>

<h2>Schloss Konopiště (1 Stunde mit dem Zug + kurzer Fußweg)</h2>
<p>Die Jagdresidenz von Erzherzog Franz Ferdinand — dessen Ermordung 1914 den Ersten Weltkrieg auslöste. Das Innere ist fast genau so erhalten, wie er es hinterließ, mit einer außergewöhnlichen Sammlung von Jagdtrophäen und Waffen. Von schönem Gelände umgeben. Zug nach Benešov u Prahy, dann 3 km Fußweg oder lokaler Bus.</p>

<h2>Praktische Tagesausflug-Tipps</h2>
<ul>
  <li>Tschechische Züge sind günstig und komfortabel — buchen Sie über <em>cd.cz</em> (Tschechische Bahn).</li>
  <li>Für Český Krumlov sind Busse (RegioJet, FlixBus) oft schneller und direkter als Züge.</li>
  <li>Früh starten — die meisten Sehenswürdigkeiten öffnen um 09:00 und schließen um 17:00–18:00 Uhr; bei Öffnung ankommen vermeidet Reisegruppen.</li>
  <li>Kutná Hora ist leicht in einem halben Tag zu erledigen; Český Krumlov erfordert mindestens einen vollen Tag.</li>
</ul>

<div class="blog-cta-box">
  <h3>Machen Sie das Beste aus Ihrem Tagesausflug</h3>
  <p>Ich kann privaten Transport und Führung für jedes dieser Ziele arrangieren — damit Sie den Kontext, die Geschichten und keinen Stress haben.</p>
  <div class="cta-buttons">
    <a class="btn btn-primary" href="/book?tour=Tagesausflug%20von%20Prag#contact-title">Tagesausflug buchen</a>
    <a class="btn btn-outline" href="/contact#contact-title">Frage stellen</a>
  </div>
</div>`,
  },
